...
/**
 * Created by DEKSTOP-MARTHA on 2/18/2018.
 */

public class MenuLink extends RecyclerView.Adapter<MenuLink.MenuViewHolder>{
...
public MenuLink(Context context, LinkedList<String> foodList, LinkedList<Integer> priceList, LinkedList<Integer> photoList) {
...
class MenuViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    final MenuLink mAdapter;
    public MenuViewHolder(final View itemView, MenuLink adapter) {
        super(itemView);
